...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    private TextView mTvImgsltCannel;
...
//        toolbar.setNavigationIcon(R.mipmap.ic_back);
        mTvImgsltCannel = (TextView) findViewById(R.id.tv_imgslt_cannel);
    ...
    public void registerListener() {
        mTvImgsltCannel.setOnClickListener(new View.OnClickListener() {
            @Override
